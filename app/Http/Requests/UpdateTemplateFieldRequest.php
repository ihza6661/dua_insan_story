    ...
    public function rules(): array
    {
        ...
        return [
            'field_key' => [
                ...
                'max:100',
                'regex:/^[a-z_]+$/',
                'unique:template_fields,field_key,'.$fieldId.',id,template_id,'.$templateId,
            ],
            'field_label' => 'sometimes|required|string|max:255',
            'field_type' => 'sometimes|required|in:text,textarea,date,time,url,email,phone,image,color',
