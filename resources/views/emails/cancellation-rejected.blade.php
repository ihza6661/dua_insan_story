...
<body>
    <div class="email-wrapper">
        <div class="header">
            ...
            <h1>✕ Cancellation Declined</h1>
            <p>Your cancellation request has been declined</p>
        </div>
        
        <div class="content">
            <p>Hi {{ $order->customer->full_name }},</p>
            
            <p>After careful review, we are unable to approve your cancellation request for order <strong>{{ $order->order_number }}</strong>.</p>
        
            <div class="warning-box">
                <strong>✕ Request Declined</strong>
                <p style="margin: 10px 0 0 0;">Your cancellation request has been reviewed and declined. Your order will continue to be processed as normal.</p>
            </div>
            ...
            <div class="order-summary">
                ...
                <p><strong>Reviewed Date:</strong> {{ $cancellationRequest->reviewed_at->format('F d, Y H:i') }}</p>
                <p><strong>Reviewed By:</strong> {{ $cancellationRequest->reviewer->full_name ?? 'Admin' }}</p>
            ...
            <div class="info-box">
                ...
                <ul style="margin: 10px 0 0 0; padding-left: 20px;">
                    <li>Your order will continue to be processed normally</li>
                    <li>We will keep you updated on your order progress</li>
                    <li>If you have concerns, please contact our customer service team</li>
            ...
            <p>If you have any questions about this decision or need further assistance, please don't hesitate to contact our customer service team. We're here to help!</p>
