...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <p>We have received your request to cancel your order. Our team will review your request and get back to you within 1-2 business days.</p>
            ...
            <div class="info-box">
                ...
                <ul style="margin: 10px 0 0 0; padding-left: 20px;">
                    ...
                    <li>We'll verify your order status and payment details</li>
                    <li>You'll receive an email with our decision within 1-2 business days</li>
                    <li>If approved, any eligible refunds will be processed according to our refund policy</li>
                </ul>
            </div>
            ...
            <p>If you have any questions about your cancellation request, please don't hesitate to contact us.</p>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 8px;">You're receiving this email because you requested to cancel your order.</p>
